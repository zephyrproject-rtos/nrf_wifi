...
#ifdef NRF_WIFI_DISABLE_PRIORITY_WINDOW_FOR_SCAN
	umac_cmd_data->disable_ptiwin_for_wifi_scan = 1;
#else
	umac_cmd_data->disable_ptiwin_for_wifi_scan = 0;
#endif /* NRF_WIFI_DISABLE_PRIORITY_WINDOW_FOR_SCAN */
