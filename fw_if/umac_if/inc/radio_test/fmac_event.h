 ...
 * @file fmac_event.h
 *
 * @brief Header containing event specific declarations in the Radio test mode
 * for the FMAC IF Layer of the Wi-Fi driver.
 */
#ifndef __FMAC_EVENT_RT_H__
#define __FMAC_EVENT_RT_H__
